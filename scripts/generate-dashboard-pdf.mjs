...
// ── Account Data ───────────────────────────────────────
const accounts = [
  { name: 'MTN MoMo', type: 'Mobile Money', balance: 4600000, color: '#FFCC00', logo: path.join(LOGOS_DIR, 'mtn.png') },
  { name: 'Orange Money', type: 'Mobile Money', balance: 1600000, color: '#FF6600', logo: path.join(LOGOS_DIR, 'orange-money.png') },
  { name: 'UBA Cameroon', type: 'Bank', balance: 0, color: '#E31837', logo: path.join(LOGOS_DIR, 'uba.png') },
  { name: 'Afriland First Bank', type: 'Bank', balance: 5000000, color: '#8B0000', logo: path.join(LOGOS_DIR, 'afriland-icon.png') },
...
function drawHeader(doc) {
  ...
  // Date
  const dateStr = 'As of March 07, 2026';
